...
def get_args():
    ...
    parser.add_argument('--raw_data_path', type=str, default="./data/kalapa_fixed_raw/")
    parser.add_argument('--raw_data_type', type=str, default='hihi', help='types: json or folder')
    parser.add_argument('--lmdb_data_path', type=str, default='./data/vilage_and_short_lmdb')
    ...
    parser.add_argument('--decode_type', type=str, default='both')
