...
def get_args():
    ...
    parser.add_argument('--pretrain_dir', type=str, default='SVTR_pretrained_large_2610')
    parser.add_argument('--ckpt_dir', type=str, default='SVTR_kalapa_2710')
    ...
    parser.add_argument('--lmdb_data_path', type=str, default='./data/kalapa_lmdb_fixed_aug/')
    ...
    parser.add_argument('--T_max', type=int, default=8000)
