...
def get_args():
    ...
    parser.add_argument('--pretrain_dir', type=str, default='SVTR_kalapa_511')
    parser.add_argument('--ckpt_dir', type=str, default='SVTR_kalapa_511')

    parser.add_argument('--raw_data_path', type=str, default="./data/kalapa_fixed_raw/checked_all_crop")
    parser.add_argument('--raw_data_type', type=str, default='hihi', help='types: json or folder')
    parser.add_argument('--lmdb_data_path', type=str, default='./data/kalapa_511_crop/')
    ...
    parser.add_argument('--num_epoch', type=str, default=500)
