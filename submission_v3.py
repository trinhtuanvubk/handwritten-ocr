...
hotwords = ["Đg", "CC", "TT", "Br", "dãy", "TP"]
unigram = ["TP", "Tp", "TP", "Ng", "ng", "Đg", "đg", "Kđtm", "Kdc", "kdt", "TDP", "Căn", "kv", "KV", "Kp", "kp"]
...
def submission(args, use_lm=True):
    with open('./111_ngram_v3.csv', 'a+') as f:
...
if __name__=="__main__":
    ...
    # 926/2/8 Nguyễn Hán Cảnh P 3 Tp Vĩnh Tân Bà Rịa Vũng Tàu